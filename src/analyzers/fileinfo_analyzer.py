...
class BasicInfoAnalyzer(BaseAnalyzer):
    ...
    def analyze(self, target_file, tool_path, plugin_config):
        ...
        # 2. Cryptographic Hashes (Standard)
        ...
        try:
            ...
            if ssdeep_hash: fuzzy_hashes["File_SSDeep"] = ssdeep_hash
        except Exception as e:
        ...
        try:
            ...
            if tlsh_hash and tlsh_hash != "TNULL": 
                fuzzy_hashes["File_TLSH"] = tlsh_hash
        except Exception as e:
        ...
        try:
            ...
            if imphash: fuzzy_hashes["File_ImpHash"] = imphash
        ...
        if fuzzy_hashes:
            summary["Fuzzy Hashes"] = fuzzy_hashes
